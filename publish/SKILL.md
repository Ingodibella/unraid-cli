---
name: unraid-cli
description: "The serious CLI for Unraid. The only installable npm package on ClawHub, not just a skill prompt. 15 command groups, 385 tests, full CRUD against the Unraid 7.2+ GraphQL API. Agent-first by design: --output json, --fields, --filter, --sort, clean exit codes, no REPL. Bash scripts and skill bundles can monitor your server, this thing can actually manage it. MIT, open source, 2.4k lines of typed TypeScript."
version: "0.5.0"
